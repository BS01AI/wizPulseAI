...
> **协议文件**: 详细行为规范见 [Codex-PROTOCOL.md](./Codex-PROTOCOL.md)
>
> **执行原则**: ⭐ 必读 [.Codex/EXECUTION_PRINCIPLES.md](./.Codex/EXECUTION_PRINCIPLES.md) — 多Agent并行执行 + 与 Cowork 协作规范
>
> **记忆系统**:
> - 长期记忆: 本文件 (AGENTS.md)
...
> - 专家团队: [.Codex/agents/README.md](./.Codex/agents/README.md)
...
### AI 记忆 (已整合到此文件)
- 原 auth-site-AGENTS.md
- 原 dashboard-site-AGENTS.md
- 原 main-site-AGENTS.md
...
**相关文档**：
- Git分支策略已更新到 `.Codex/agents/git-manager.md`
...
```
wizPulseAI/
├── AGENTS.md (符号链接 → wizPulseAI-docs/AGENTS.md)
